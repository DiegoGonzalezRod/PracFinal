...
import Clients from "@/app/componentes/pag/clients";
      ...
      <header className="bg-gradient-to-r from-blue-600 to-blue-500 text-white py-6 shadow-lg">
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-extrabold tracking-tight">Gestión de Clientes</h1>
              <p className="text-gray-200 mt-2">
                Administra, visualiza y organiza todos tus clientes desde aquí.
              </p>
            </div>
            <div>
              <Image
                src="/images/clientes.png" // Ruta corregida
                alt="Logo"
